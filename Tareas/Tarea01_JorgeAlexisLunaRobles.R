...
barplot(superficie, main = "Superficie", col = rainbow(5), 
        ylab = "Héctareas", xlab = "Género", cex.axis = (0.7), 
        cex.names = (0.7), ylim = c(0, 3500),
...
barplot(sup_decreciente, main = "Superficie Decreciente", col = rainbow(5), 
        ylab = "Héctareas", xlab = "Género", cex.axis = (0.7), 
        cex.names = (0.7), ylim = c(0, 3500),
        names.arg = c("Pinus", "Mezquite", "Teka", "Juniperus", "Encinos"))
mean (superficie)
